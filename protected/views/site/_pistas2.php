...
<div class="col-md-12"><h1>SECTOR II</h1></div>
...
<table class="tg table">
  ...
  <?php foreach ($pistas_s2_1 as $pista): ?>
...
<table class="tg table">
  ...
  <tr>
    <th class="tg-031e" style="width: 400px">PISTA<br></th>
    <th class="tg-031e">ESTADO</th>
    <th class="tg-031e">NIEVE</th>
  </tr>

  <?php foreach ($pistas_s2_2 as $pista): ?>
...
<table class="tg table">
  ...
  <?php foreach ($pistas_c2 as $pista): ?>
