<div class="container-keypad">
	<ul class="keypad">
		<a href="#" class="press" id="7">
			<li class="button hvr-grow"><p class="number">7</p></li>
			<div class="clearfix"></div>
		</a>
		<a href="#" class="press" id="8">
			<li class="button hvr-grow"><p class="number">8</p></li>
			<div class="clearfix"></div>
		</a>
		<a href="#" class="press" id="9">
			<li class="button hvr-grow">
				<p class="number">9</p>
			</li>
			<div class="clearfix"></div>
		</a>
		...
		<a href="#" class="press" id="DEL">
			<li class="button clear">
				<p class="number"><span class="glyphicon glyphicon-remove" style="top:6px"></p>
			</li>
			<div class="clearfix"></div>
		</a>
