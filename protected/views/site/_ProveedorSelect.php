...
<h2>SELECCIONÁ EL LUGAR...</h2>

<?php foreach ($proveedores as $proveedor): ?>
	
<button type="button" onfocus="javascripts:selectProve(this.value)" id="bot<?php echo $proveedor->idProveedor; ?>" class="btn move btn-proveedores" value="<?php echo $proveedor->idProveedor; ?>" autocomplete="off"><?php echo $proveedor->nombre; ?></button>
