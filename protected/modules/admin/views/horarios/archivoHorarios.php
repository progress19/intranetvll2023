...
<?php $this->titulo='<i class="fa fa-fw fa-archive"></i> Archivo Horarios';
  $this->menu_archivo = 'active';
  $this->menu_archivo_horarios = 'active';
?>
  ...
  <script type="text/javascript">
    ...
    function getEstadisticas() {
      ...
      $.ajax({
         url: "<?php echo URLRAIZ.'/admin/horarios/archivoHorariosAjax' ?>",
