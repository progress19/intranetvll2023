...
<?php $this->titulo='<i class="fa fa-fw fa-archive"></i> Archivo Asistencias';
  $this->menu_archivo = 'active';
  $this->menu_archivo_asistencias = 'active';
?>
  ...
  <script type="text/javascript">
    ...
    function getEstadisticas() {
      ...
      $.ajax({
         url: "<?php echo URLRAIZ.'/admin/asistencias/archivoAsisAjax' ?>",
