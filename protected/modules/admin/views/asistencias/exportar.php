...
/* @var $model Asistencias */
  ...
  $this->menu_asistencias_exportar = 'active';
  
  $this->titulo='<i class="fa fa-fw fa-file-excel-o"></i> Exportar Asistencias a Excel';
...
<div style="padding-top: 19px;" class="col-md-3">
    <a class="btn btn-primary" onclick="asistenciasExcel()" style="text-decoration: none;" >
