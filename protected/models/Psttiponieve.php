...
/**
 * This is the model class for table "psttiponieve".
 *
 * The followings are the available columns in table 'psttiponieve':
 * @property string $idTipo
 * @property string $nombre_es
 * @property string $nombre_pr
 * @property string $nombre_en
 */
class Psttiponieve extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('idTipo, nombre_es, nombre_pr, nombre_en', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return Psttiponieve the static model class
	 */
