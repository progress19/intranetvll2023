...
/**
 * This is the model class for table "pstsectores".
 *
 * The followings are the available columns in table 'pstsectores':
 ...
 * @property Pstpistas[] $pstpistases
 */
class Sectorespst extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('idSector, nombre_es, nombre_pr, nombre_en', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'pstpistases' => array(self::HAS_MANY, 'Pstpistas', 'idSector'),
		);
	}
	 ...
	 * @return Sectorespst the static model class
	 */
