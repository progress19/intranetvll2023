...
/**
 * This is the model class for table "pstestados".
 *
 * The followings are the available columns in table 'pstestados':
 * @property string $idEstado
 * @property string $nombre_es
 * @property string $nombre_pr
 * @property string $nombre_en
 */
class Pstestados extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('idEstado, nombre_es, nombre_pr, nombre_en', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return Pstestados the static model class
	 */
